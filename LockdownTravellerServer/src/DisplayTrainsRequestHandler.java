...
public class DisplayTrainsRequestHandler extends Handler {
    ...
    DisplayTrainsResponse DisplayTrains(String query1, String query2, String query3, String query4, String query5, String query6, String query7, String sDate, String source, String dest) {
        ...
        ArrayList<String> First_AC = new ArrayList<>();
        ArrayList<String> Second_AC = new ArrayList<>();
        ArrayList<String> Third_AC = new ArrayList<>();
        ArrayList<String> Sleeper = new ArrayList<>();
        int i = 0;
            ...
            if (value == '1') {
                try {
                    ...
                    if (counter == 1) {
                        ...
                        } else Sleeper.add(String.valueOf(available_seats));
                        ...
                        } else First_AC.add(String.valueOf(available_seats));
                        ...
                        } else Second_AC.add(String.valueOf(available_seats));
                        ...
                        } else Third_AC.add(String.valueOf(available_seats));
                        i++;
                    }
                } catch (SQLException e) {
                    e.printStackTrace();
