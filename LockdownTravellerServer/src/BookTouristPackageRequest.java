...
public class BookTouristPackageRequest extends Request implements Serializable {
    private ArrayList<String> name,mealPreference;
    private ArrayList<Integer> age;
    private ArrayList<Character>gender;
    private String boardingPoint,userID,packageID;
    private int availableSeats;

    public BookTouristPackageRequest(ArrayList<String> name, ArrayList<String> mealPreference, ArrayList<Integer> age, ArrayList<Character> gender, String boardingPoint, String userID, String packageID, int availableSeats) {
        this.name = name;
